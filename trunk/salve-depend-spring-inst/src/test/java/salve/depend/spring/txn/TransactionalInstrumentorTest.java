...
public class TransactionalInstrumentorTest extends Assert
{
    ...
    /**
     * Test that constructors of an annotated class are not instrumented but methods are
     * 
     * @throws Exception
     */
    @SuppressWarnings("static-access")
    ...
    /**
     * Test that a mere <code>throws</code> declaration does not cause a rollback
     * 
     * @throws Exception
     */
    @Test
    ...
    public void testExceptionOkWithException() throws Exception
    {
        new RollbackTemplate()
        {
            ...
            protected void testExpectations() throws Exception
            {
                try
                {
                    ((MethodBean)mbClass.newInstance()).exceptionOkWithException();
                }
    ...
    /**
     * Test that unexpected exception thrown from within transactional method causes a rollback
     * 
     * @throws Exception
     */
    @Test
    ...
    /**
     * This method makes sure that any annotation except {@link Transactional} is kept on the outer
     * method instead of moved into the delegate method
     * 
     ...
     */
    @Test
    public void testMethodByAnnotationLocation() throws IllegalAccessException,
    ...
    /**
     * Test that unexpected exception thrown from a method call inside a transactional method causes
     * the transactional method to rollback
     * 
     * @throws Exception
     */
    @Test
    ...
    private static abstract class RollbackTemplate extends TxnTemplate
    {
        ...
        protected void setupExpectations(Object status)
        {
            ...
            // manager.start(?,?);
            EasyMock.expect(
                    tm.start((TransactionAttribute)EasyMock.anyObject(), (String)EasyMock
    ...
    /**
     * Easy mock template that sets up expections for a single successful runthrough of a
    ...
    /**
     * Easy mock template that sets up expections for a single runthrough of a transactional method
     * 
     * @author igor.vaynberg
     */
